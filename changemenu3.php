 ...
 if (USER::isLog($DB)){
   ...
   $id= $_SESSION['user']['id'];
    $menus= $DB->query("select menu.id, menu.nom, menu.titre, menu.contenu, menu.users_id from menu where id=3
    ...
    if ($validate) {
      ...
      $data = array(
         ...
         $inc = $DB->insert('update menu set nom=:nom,titre=:titre,contenu=:contenu where id="3" ',$data);
          ...
          <div id="article">
            ...
            <div id="box_modif">
                ...
                <div class="col-md-12">
                    ...
                    <form action = "changemenu3.php" method= "POST" enctype = "multipart/form-data">
