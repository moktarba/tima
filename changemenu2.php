 ...
 if (USER::isLog($DB)){
   ...
   $id= $_SESSION['user']['id'];
    $menus= $DB->query("select menu.id, menu.nom, menu.titre, menu.contenu, menu.users_id from menu where id=2
    ...
    if ($validate) {
      ...
      $data = array(
         ...
         $inc = $DB->insert('update menu set nom=:nom,titre=:titre,contenu=:contenu where id="2" ',$data);
          ...
          <div id="article">
            ...
            <div id="box_modif">
                ...
                <div class="col-md-12">
                    ...
                    <form action = "changemenu2.php" method= "POST" enctype = "multipart/form-data">
                    <input type="hidden" name ="id" value= "<?php echo $_SESSION['user']['id']; ?>">
                         ...
                         <div class="panel panel-default">
                          ...
                          <table class="table">
                            ...
                            <tr>
                              <td> 
                                <input type = "text" name = "nom" value="<?php echo isset($_POST['nom']) ? $menus[1]->nom : ""; ?>">
                              </td>   
                              <td>                 
                                 <input type = "text" name = "titre" value="<?php echo isset($_POST['titre']) ? $menus[1]->titre : ""; ?>">
                               </td>
                              <td>  
                                <input type = "text" name = "contenu" value="<?php echo isset($_POST['contenu']) ? $menus[1]->contenu : ""; ?>">
                              </td>
                            </tr>
